...
namespace InvoiceTestApp.Migrations
{
    ...
    [Migration("20201211015616_InitialCreate")]
            ...
            modelBuilder.Entity("InvoiceTestApp.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ChargeId = 1,
                            ClientId = 1,
                            EndDate = new DateTime(2020, 11, 26, 2, 56, 14, 968, DateTimeKind.Local).AddTicks(9126),
                            InvoiceDate = new DateTime(2020, 12, 6, 2, 56, 14, 962, DateTimeKind.Local).AddTicks(8620),
                            InvoiceNumber = 123,
                            Rate = 0.20000000000000001,
                            StartDate = new DateTime(2020, 10, 27, 2, 56, 14, 968, DateTimeKind.Local).AddTicks(7567),
                        ...
                        new
                        {
                            ...
                            ChargeId = 2,
                            ClientId = 1,
                            EndDate = new DateTime(2020, 11, 26, 2, 56, 14, 969, DateTimeKind.Local).AddTicks(8306),
                            InvoiceDate = new DateTime(2020, 12, 6, 2, 56, 14, 969, DateTimeKind.Local).AddTicks(8222),
                            InvoiceNumber = 225,
                            Rate = 0.29999999999999999,
                            StartDate = new DateTime(2020, 10, 27, 2, 56, 14, 969, DateTimeKind.Local).AddTicks(8278),
                            Tax = 0.17000000000000001,
                            Total = 999.0,
                            Units = 356.0
                        });
